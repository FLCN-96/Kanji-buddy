...
(function() {
  const RANKS = [
    ...
    { i:10, rom:'Ⅹ',  name:'SAGE',      kanji:'賢者',   kana:'KENJA',         gloss:'the wise one',        glyph:'賢', color:'amber',     threshold:26000 },
    { i:11, rom:'Ⅺ',  name:'MASTER',    kanji:'先生',   kana:'SENSEI',        gloss:'the teacher',         glyph:'師', color:'amber',     threshold:36000 },
    { i:12, rom:'Ⅻ',  name:'ASCENDANT', kanji:'神使',   kana:'KAMI-TSUKAI',   gloss:'the divine envoy',    glyph:'神', color:'transcend', threshold:55000 },
  ];
